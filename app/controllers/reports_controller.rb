    ...
    respond_to do |format|
      ...
      format.pdf do
        render pdf: "Customized report",
                page_size: 'A4',
                template: "reports/providers_pdf.html.erb",
  ...
  def snapshot_tested
    ...
    respond_to do |format|
      format.pdf do
        render pdf: "Customized report",
                page_size: 'A4',
                template: "reports/snapshot_pdf.html.erb",
                layout: "clinic_print.html.erb",
                orientation: "Landscape",
                lowquality: true,
                zoom: 1,
  ...
  def capacity
    ...
    respond_to do |format|
      ...
      format.pdf do
        render pdf: "Customized report",
                page_size: 'A4',
                template: "reports/capacity_pdf.html.erb",
                layout: "clinic_print.html.erb",
                orientation: "Landscape",
                lowquality: true,
                zoom: 1,
  ...
  def uptake
    ...
    respond_to do |format|
      ...
      format.pdf do
        render pdf: "Customized report",
                page_size: 'A4',
                template: "reports/uptake_pdf.html.erb",
                layout: "clinic_print.html.erb",
                orientation: "Landscape",
                lowquality: true,
                zoom: 1,
  ...
  def locations
    ...
    respond_to do |format|
      ...
      format.pdf do
        render pdf: "Customized report",
                page_size: 'A4',
                template: "reports/locations_pdf.html.erb",
                layout: "clinic_print.html.erb",
                orientation: "Landscape",
                lowquality: true,
                zoom: 1,
  ...
  def employers
    ...
    respond_to do |format|
      ...
      format.pdf do
        render pdf: "Customized report",
                page_size: 'A4',
                template: "reports/employers_pdf.html.erb",
                layout: "clinic_print.html.erb",
                orientation: "Landscape",
                lowquality: true,
                zoom: 1,
  ...
  def supply_inventories
    ...
    respond_to do |format|
      ...
      format.pdf do
        render pdf: "Customized report",
                page_size: 'A4',
                template: "reports/supply_inventories_pdf.html.erb",
                layout: "clinic_print.html.erb",
                orientation: "Landscape",
                lowquality: true,
                zoom: 1,
  ...
  def news_and_notifications
    ...
    respond_to do |format|
      ...
      format.pdf do
        render pdf: "Customized report",
                page_size: 'A4',
                template: "reports/#{template_name}_pdf.html.erb",
                layout: "clinic_print.html.erb",
                orientation: "Landscape",
                lowquality: true,
                zoom: 1,
